#!/usr/bin/env python3
"""Assemble and validate bounded v0.1.7 internal playtest bundles."""
...
def _spec() -> dict[str, Any]:
    ...
    if spec["schema_version"] != 1 or spec["release"] != "v0.1.7":
...
def validate_manifest(manifest: dict[str, Any], bundle_dir: Path) -> None:
    ...
    if manifest["schema_version"] != 1 or manifest["release"] != "v0.1.7":

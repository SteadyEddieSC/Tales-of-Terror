...
def validate_status(s:dict[str,Any])->None:
 ...
 checks(s,[
 ('schema_version',10),('status_kind','post_prototype_project_status'),('protected_main',BASE),('protected_main_semantics','exact_reconciliation_starting_baseline'),('as_of_date','2026-09-08'),('playable_release','v0.1.9'),('pending_inputs',[]),('closed_unmerged_pull_requests',[32,154]),('unrelated_open_pull_requests',[142,143,144,145,158]),('human_evidence_claimed',False),('runtime_implementation_authorized',False),('ux_implementation_authorized',False),('visual_implementation_authorized',False),

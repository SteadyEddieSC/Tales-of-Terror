...
def main() -> int:
    ...
    imitation["entries"][0]["generator_guidance"]["prompt"] += " in the style of a famous illustrator"
    ...
    licensed_entry = next(
        ...
        if "licensed_transformed" in entry["provenance_policy"]["allowed_source_kinds"]
    )

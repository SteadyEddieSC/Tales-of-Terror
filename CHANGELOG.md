...
- Added an exact version-1, bounded, local-only playtest report with privacy-filtered public/aggregate observations, explicit JSON/Markdown export through a replaceable writer, and a fixed `user://playtest_exports` destination.

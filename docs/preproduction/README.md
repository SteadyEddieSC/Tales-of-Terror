...
- [P0.20 Release Summary](P0.20_Release_Summary.md)
...
- P0.1–P0.19 release summaries remain the authoritative package-by-package history.
...
P0.19 completed issues #80–#86 and authorized no successor implementation issue.

## Current production boundary

Lantern House remains the sole production/default Tale. Drowned Harbor remains development-only, test-isolated, explicit-test-script-only, production-unregistered, and excluded from ordinary Windows/Linux exports.
...
P0.20 recommends P0.21 as the next separately authorized planning package: a production architecture and Tale-compilation contract. It does not activate P0.21 or any runtime work.

Codex is not the default destination. Release Management handles repository reconciliation, roadmap work, issue/PR governance, CI review, and bounded GitHub-native changes. Codex is reserved for substantial local implementation after a dedicated runtime issue is activated.

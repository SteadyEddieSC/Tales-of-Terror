...
Cloudflare credentials and a live deployment are intentionally unnecessary. Physical-phone Wi-Fi behavior, mixed Android/iOS browsers, router/firewall/NAT variants, television-distance review, production security/privacy/legal review, and long-session observation remain deferred manual gates.

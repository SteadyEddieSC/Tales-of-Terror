...
- Eight player accents use a grid-arranged, color-vision-conscious palette derived from the Okabe–Ito family. Bright and dark values alternate across horizontal and vertical neighbors. Identity colors never redefine success or danger.

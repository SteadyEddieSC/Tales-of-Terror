...
func _test_identity_and_support_page() -> void:
	...
	_expect(identity.release == "v0.1.6", "uses the v0.1.6 project release identity")
	_expect(
		(
	...
	_expect("RELEASE   v0.1.6" in support, "renders the exact release")
	_expect(

...
const WALLS: Array[Rect2] = [
	Rect2(0, 0, 1800, 32), Rect2(0, 968, 1800, 32), Rect2(0, 0, 32, 1000), Rect2(1768, 0, 32, 1000),
	Rect2(890, 32, 38, 365), Rect2(890, 603, 38, 365),
	Rect2(220, 220, 220, 42), Rect2(570, 690, 240, 42), Rect2(1180, 220, 310, 42),
